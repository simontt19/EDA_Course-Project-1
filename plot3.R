...
# ==================================================
#   Description:
#   Electric power consumption data plotting -plot3
# 
# History:
...
with(data_l,legend("topright",col=c("black","red","blue"),legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"),lty=1,cex=1))
