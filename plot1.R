...
# ==================================================
#   Description:
#   Electric power consumption data plotting - plot1
# 
# History:
...
with(data_l,hist(Global_active_power,col="red",main="Global Active Power",xlab = "Global Active Power (kilowatts)"))
